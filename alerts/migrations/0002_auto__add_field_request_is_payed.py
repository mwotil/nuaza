...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.is_payed'
        db.add_column('request', 'is_payed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Request.is_payed'
        db.delete_column('request', 'is_payed')

    models = {
        'alerts.request': {
            'Meta': {'ordering': "['-submitted_at']", 'object_name': 'Request', 'db_table': "'request'"},
