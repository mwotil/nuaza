...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('search_searchterm', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('q', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('cat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pdcts.Category'], null=True)),
            ('search_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('ip_address', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('tracking_id', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
        ))
        db.send_create_signal('search', ['SearchTerm'])

    def backwards(self, orm):
        # Deleting model 'SearchTerm'
        db.delete_table('search_searchterm')
    ...
    models = {
        ...
        'search.searchterm': {
            ...
            'cat': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pdcts.Category']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'max_length': '15'}),
            'q': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'search_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
