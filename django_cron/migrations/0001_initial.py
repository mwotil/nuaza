...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('django_cron_job', (
            ...
            ('last_run', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 26, 0, 0))),
    ...
    models = {
        ...
        'django_cron.job': {
            ...
            'last_run': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 26, 0, 0)'}),
