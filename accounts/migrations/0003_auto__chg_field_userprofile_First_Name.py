...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.First_Name'
        db.alter_column('accounts_userprofile', 'First_Name', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    def backwards(self, orm):

        # Changing field 'UserProfile.First_Name'
        db.alter_column('accounts_userprofile', 'First_Name', self.gf('django.db.models.fields.CharField')(max_length=25))
    models = {
