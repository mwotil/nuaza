...
#from Nuaza.settings import DEBUG
import datetime
import re
...
class CheckoutForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['shipping_district'].widget.attrs['size'] = '20'
        self.fields['shipping_location'].widget.attrs['size'] = '20'
        
        self.fields['billing_district'].widget.attrs['size'] = '20'
        self.fields['billing_location'].widget.attrs['size'] = '20'
    ...
    def clean_phone(self):
        ...
        if len(stripped_phone) < 10:
            raise forms.ValidationError('Enter a valid phone number with area code.(e.g. 0772-345-678)')
